...
#     M = np.block([[m_rho_rho, m0, m_rho_Vr, m_rho_Vz], 
# 				[m_Btheta_rho, m_Btheta_Btheta, m_Btheta_Vr, m_Btheta_Vz], 
# 				[m_Vr_rho, m_Vr_Btheta, m_Vr_Vr, m0],
# 				[m_Vz_rho, m_Vz_Btheta, m0, m_Vz_Vz]])
    return M
...
##
nr, r_max, dr, r, rr = grid(size=800, max=5.0)
