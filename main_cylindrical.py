...
sys   = System(n_ghost=1, resR=256, r_max=2*np.pi, resZ=256, z_max=2*np.pi, D_eta=0, D_H=0.1, D_P=0, B_Z0=0)
equ_a = AnalyticalEquilibriumCyl(sys, p_exp=4)
equ_n = NumericalEquilibriumCyl(sys, p_exp=4)
lin = None # LinearCyl(equ_a, k=1, m=0, rosh=5/3)
evo = None # EvolveCyl(sys, equ_a, lin, k=1, rosh=2, D_nu=0)
